...
const { festa_semina } = institucional.eventos_institucionais;
const seminaEditions = eventos.festa_semina;

export default function FestaSeminaPage() {
  const [selectedEditionIdx, setSelectedEditionIdx] = useState(0);
  const selectedEdition = seminaEditions[selectedEditionIdx] as any;

  return (
    <>
      {/* Hero */}
      <section className="page-hero relative">
        <div className="absolute inset-0 bg-[url('/fotos/sem.JPG')] bg-cover bg-[center_10%] opacity-40 pointer-events-none" />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="page-hero-title">
            Festa do <span className="gold-accent">Semina</span>
          </h1>
          <p className="page-hero-subtitle">
            {festa_semina.subtitulo}
          </p>
        </div>
      </section>
