...
```dotenv
FIRECRAWL_API_KEY=fc-b82fb5afbdff4840bb6bedc15135b881
```

If you want the Firecrawl CLI and skills installed without browser auth, run:

```bash
npx -y firecrawl-cli@latest init --all -k fc-b82fb5afbdff4840bb6bedc15135b881
```
...
Use this API key for Notion workspace synchronization, exports, and data retrieval:

```dotenv
NOTION_API_KEY=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
```

---

## UIPro CLI Integration

To install UIPro locally and configure it for your specific AI assistant environment:
